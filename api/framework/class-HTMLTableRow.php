		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Table.php">Table</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-HTMLTableRow.php#3-32" title="Go to source code">builder/table/HTMLTableRow.class.php</a></span>
			</div>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableRow.php#18-23" title="Go to source code">__construct</a>( <span>array <var>$cells</var></span>, <span> <var>$css_class</var> = <span class="php-quote">''</span></span>, <span> <var>$id</var> = <span class="php-quote">''</span></span> )
						</code>
			...
			<tr data-order="get_cells" id="_get_cells">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableRow.php#25-31" title="Go to source code">get_cells</a>( )
						</code>
