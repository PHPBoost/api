		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Form.php">Form</a>\<a href="package-Builder.Form.field.php">field</a>\<a href="package-Builder.Form.field.constraint.php">constraint</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FormFieldConstraintIntegerMin.php#3-52" title="Go to source code">builder/form/field/constraint/FormFieldConstraintIntegerMin.class.php</a></span>
			</div>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldConstraintIntegerMin.php#20-29" title="Go to source code">__construct</a>( <span> <var>$lower_bound</var></span>, <span> <var>$js_message</var> = <span class="php-quote">''</span></span> )
						</code>
			...
			<tr data-order="validate" id="_validate">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldConstraintIntegerMin.php#31-45" title="Go to source code">validate</a>( <span><code><a href="class-FormField.php">FormField</a></code> <var>$field</var></span> )
						</code>
			...
			<tr data-order="get_js_validation" id="_get_js_validation">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldConstraintIntegerMin.php#47-51" title="Go to source code">get_js_validation</a>( <span><code><a href="class-FormField.php">FormField</a></code> <var>$field</var></span> )
						</code>
