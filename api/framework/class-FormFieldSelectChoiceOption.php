		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Form.php">Form</a>\<a href="package-Builder.Form.field.php">field</a>\<a href="package-Builder.Form.field.enum.php">enum</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FormFieldSelectChoiceOption.php#3-44" title="Go to source code">builder/form/field/enum/FormFieldSelectChoiceOption.class.php</a></span>
			</div>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldSelectChoiceOption.php#18-26" title="Go to source code">__construct</a>( <span> <var>$label</var></span>, <span> <var>$raw_value</var></span>, <span>string[] <var>$field_choice_options</var> = <span class="php-keyword1">array</span>()</span> )
						</code>
			...
			<tr data-order="display" id="_display">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-FormFieldSelectChoiceOption.php#28-43" title="Go to source code">display</a>( )
						</code>
