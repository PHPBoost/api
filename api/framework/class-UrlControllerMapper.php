		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-MVC.php">MVC</a>\<a href="package-MVC.Dispatcher.php">Dispatcher</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-UrlControllerMapper.php#3-71" title="Go to source code">mvc/dispatcher/UrlControllerMapper.class.php</a></span>
			</div>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-UrlControllerMapper.php#19-32" title="Go to source code">__construct</a>( <span>string <var>$classname</var></span>, <span>string <var>$capture_regex</var> = <span class="php-quote">'`^/?$`u'</span></span>, <span>string <var>$parameters_names</var> = <span class="php-keyword1">array</span>()</span> )
						</code>
			...
			<tr data-order="call" id="_call">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-UrlControllerMapper.php#34-41" title="Go to source code">call</a>( )
						</code>
