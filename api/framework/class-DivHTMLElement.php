		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Element.php">Element</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-DivHTMLElement.php#3-45" title="Go to source code">builder/element/DivHTMLElement.class.php</a></span>
			</div>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DivHTMLElement.php#18-23" title="Go to source code">__construct</a>( <span> <var>$content</var></span>, <span> <var>$attributs</var> = <span class="php-keyword1">array</span>()</span>, <span> <var>$css_class</var> = <span class="php-quote">''</span></span> )
						</code>
			...
			<tr data-order="display" id="_display">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-DivHTMLElement.php#25-44" title="Go to source code">display</a>( )
						</code>
