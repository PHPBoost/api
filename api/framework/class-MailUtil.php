		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Mail.php">Mail</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-MailUtil.php#3-47" title="Go to source code">io/mail/MailUtil.class.php</a></span>
			</div>
			...
			<tr data-order="is_mail_valid" id="_is_mail_valid">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MailUtil.php#20-28" title="Go to source code">is_mail_valid</a>( <span>string <var>$mail_address</var></span> )
						</code>
			...
			<tr data-order="get_mail_checking_regex" id="_get_mail_checking_regex">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MailUtil.php#30-37" title="Go to source code">get_mail_checking_regex</a>( )
						</code>
			...
			<tr data-order="get_mail_checking_raw_regex" id="_get_mail_checking_raw_regex">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-MailUtil.php#39-46" title="Go to source code">get_mail_checking_raw_regex</a>( )
						</code>
