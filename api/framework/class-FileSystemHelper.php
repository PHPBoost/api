<?php require_once('../api_begin.php'); ?>	<div id="inside-global">
		<div id="inside-menu-left">
			...
			<div id="elements">
				...
				<ul>
					<li class="active"><a href="class-FileSystemHelper.php" class="cssmenu-title">FileSystemHelper</a></li>
...
<section id="content" class="class">
	...
	<article>
		<header><h2>FileSystemHelper</h2></header>
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Helper.php">Helper</a></span>
						...
						<span class="infos-options">
							<b>Since:</b>
							PHPBoost 5.2 - 2019 02 14
						</span>
					<span class="infos-options"><b>Located at:</b> <a href="source-class-FileSystemHelper.php#3-147" title="Go to source code">helper/FileSystemHelper.class.php</a></span>
			</div>

			<div class="description">
				<p>File System helper</p>
			</div>
		...
		<div class="content">
			...
			<tr data-order="remove_folder" id="_remove_folder">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_remove_folder">#</a>
						<code>
<a href="source-class-FileSystemHelper.php#14-59" title="Go to source code">remove_folder</a>( <span>string <var>$folder</var></span>, <span>boolean <var>$protect_folder</var> = <span class="php-keyword1">false</span></span>, <span>string <var>$first_folder_name</var> = <span class="php-quote">''</span></span>, <span>string <var>$parent_folder</var> = <span class="php-quote">''</span></span> )
						</code>

							<div class="description short">
								<p>Remove a folder and its content. The folder can be kept and only emptied.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Remove a folder and its content. The folder can be kept and only emptied.</p>
								...
								<div class="list"><dl>
									...
									<dd>The name of the folder to delete.</dd>
									<dt><var>$protect_folder</var></dt>
									<dd>True if the original folder has to be kept. False per default.</dd>
									<dt><var>$first_folder_name</var></dt>
									<dd>The name of the first folder if it has to be kept. No need to fill it, used for recursive matter.</dd>
									<dt><var>$parent_folder</var></dt>
									<dd>The name of the parent folder. No need to fill it, used for recursive matter.</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									boolean<br>True if the folder is successfully removed, otherwise false.
								</div>
			...
			<tr data-order="copy_folder" id="_copy_folder">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_copy_folder">#</a>
						<code>
<a href="source-class-FileSystemHelper.php#61-92" title="Go to source code">copy_folder</a>( <span>string <var>$source_path</var></span>, <span>string <var>$destination_path</var></span> )
						</code>

							<div class="description short">
								<p>Copy a folder from a source path to a destination.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Copy a folder from a source path to a destination.</p>
								...
								<h6>Parameters</h6>
								<div class="list"><dl>
									<dt><var>$source_path</var></dt>
									<dd>Source path of the folder.</dd>
									<dt><var>$destination_path</var></dt>
									<dd>Destination path of the folder.</dd>
								</dl></div>
			...
			<tr data-order="download_remote_file" id="_download_remote_file">
				...
				<td class="name">
					<div>
						<a class="anchor" href="#_download_remote_file">#</a>
						<code>
<a href="source-class-FileSystemHelper.php#94-146" title="Go to source code">download_remote_file</a>( <span>string <var>$url</var></span>, <span>string <var>$destination_path</var></span>, <span>string <var>$extract_archive</var> = <span class="php-keyword1">true</span></span>, <span>string <var>$retry</var> = <span class="php-keyword1">false</span></span> )
						</code>

							<div class="description short">
								<p>Download a file from a remote url with md5 sum check and extract it if needed in case of a zip file. Curl library needed.</p>
							</div>
						...
						<div class="description detailed hidden">
							<p>Download a file from a remote url with md5 sum check and extract it if needed in case of a zip file. Curl library needed.</p>
								...
								<div class="list"><dl>
									<dt><var>$url</var></dt>
									<dd>Url of the remote file.</dd>
									<dt><var>$destination_path</var></dt>
									<dd>Destination path of the file.</dd>
									<dt><var>$extract_archive</var></dt>
									<dd>Extract the content of the zip file and delete the zip file if true.</dd>
									<dt><var>$retry</var></dt>
									<dd>Second try if the archive is corrupted. No need to use this parameter, it is used automatically by the function.</dd>
								</dl></div>

								<h6>Returns</h6>
								<div class="list">
									boolean<br>True if the file is successfully downloaded, otherwise false.
								</div>
