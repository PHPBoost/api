		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.HTTP.php">HTTP</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-UnexistingHTTPParameterException.php#3-18" title="Go to source code">io/http/UnexistingHTTPParameterException.class.php</a></span>
			</div>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-UnexistingHTTPParameterException.php#14-17" title="Go to source code">__construct</a>( <span> <var>$varname</var></span> )
						</code>
