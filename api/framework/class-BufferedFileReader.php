		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Filesystem.php">Filesystem</a>\<a href="package-IO.Filesystem.stream.php">stream</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-BufferedFileReader.php#3-109" title="Go to source code">io/filesystem/stream/BufferedFileReader.class.php</a></span>
			</div>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-BufferedFileReader.php#27-31" title="Go to source code">__construct</a>( <span><code><a href="class-File.php">File</a></code> <var>$file</var></span>, <span> <var>$buffer_size</var> = self::DEFAULT_BUFFER_SIZE</span> )
						</code>
			...
			<tr data-order="read_all" id="_read_all">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-BufferedFileReader.php#33-41" title="Go to source code">read_all</a>( )
						</code>
			...
			<tr data-order="read_line" id="_read_line">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-BufferedFileReader.php#55-73" title="Go to source code">read_line</a>( )
						</code>
			...
			<div class="responsive-table">
				<table class="summary constants" id="constants">
					...
					<tr data-order="DEFAULT_BUFFER_SIZE" id="DEFAULT_BUFFER_SIZE">
						...
						<td class="name">
							<code>
								<a href="source-class-BufferedFileReader.php#16" title="Go to source code"><b>DEFAULT_BUFFER_SIZE</b></a>
							</code>
