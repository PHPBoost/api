		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-MVC.php">MVC</a>\<a href="package-MVC.Response.php">Response</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-AdminDisplayResponse.php#3-19" title="Go to source code">mvc/response/AdminDisplayResponse.class.php</a></span>
			</div>
			...
			<tr data-order="__construct" id="___construct">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-AdminDisplayResponse.php#15-18" title="Go to source code">__construct</a>( <span> <var>$view</var></span>, <span> <var>$location_id</var> = <span class="php-quote">''</span></span> )
						</code>
