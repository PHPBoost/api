		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-IO.php">IO</a>\<a href="package-IO.Template.php">Template</a>\<a href="package-IO.Template.parser.php">parser</a>\<a href="package-IO.Template.parser.syntax.php">syntax</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-ConstantTemplateSyntaxElement.php#3-32" title="Go to source code">io/template/parser/syntax/ConstantTemplateSyntaxElement.class.php</a></span>
			</div>
			...
			<tr data-order="is_element" id="_is_element">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-ConstantTemplateSyntaxElement.php#14-17" title="Go to source code">is_element</a>( <span><code><a href="class-StringInputStream.php">StringInputStream</a></code> <var>$input</var></span> )
						</code>
