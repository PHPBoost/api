		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Doctrine.php">Doctrine</a>\<a href="package-Doctrine.DBAL.php">DBAL</a>\<a href="package-Doctrine.DBAL.Types.php">Types</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-BooleanType.php#3-33" title="Go to source code">io/db/dbms/Doctrine/DBAL/Types/BooleanType.php</a></span>
			</div>
			...
			<tr data-order="getSqlDeclaration" id="_getSqlDeclaration">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-BooleanType.php#14-17" title="Go to source code">getSqlDeclaration</a>( <span>array <var>$fieldDeclaration</var></span>, <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
			...
			<tr data-order="convertToDatabaseValue" id="_convertToDatabaseValue">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-BooleanType.php#19-22" title="Go to source code">convertToDatabaseValue</a>( <span>mixed <var>$value</var></span>, <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
			...
			<tr data-order="convertToPHPValue" id="_convertToPHPValue">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-BooleanType.php#24-27" title="Go to source code">convertToPHPValue</a>( <span>mixed <var>$value</var></span>, <span><code><a href="class-AbstractPlatform.php">AbstractPlatform</a></code> <var>$platform</var></span> )
						</code>
			...
			<tr data-order="getName" id="_getName">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-BooleanType.php#29-32" title="Go to source code">getName</a>( )
						</code>
