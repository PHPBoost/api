		...
		<div class="content">
			...
			<div class="options infos">
				...
				<span class="infos-options"><b>Package:</b> <a href="package-Builder.php">Builder</a>\<a href="package-Builder.Table.php">Table</a>\<a href="package-Builder.Table.filter.php">filter</a>\<a href="package-Builder.Table.filter.sql.php">sql</a></span>
					...
					<span class="infos-options"><b>Located at:</b> <a href="source-class-HTMLTableEscapedLikeTextSQLFilter.php#3-21" title="Go to source code">builder/table/filter/sql/HTMLTableEscapedLikeTextSQLFilter.class.php</a></span>
			</div>
			...
			<tr data-order="set_value" id="_set_value">
				...
				<td class="name">
					<div>
						...
						<code>
<a href="source-class-HTMLTableEscapedLikeTextSQLFilter.php#14-20" title="Go to source code">set_value</a>( <span> <var>$value</var></span> )
						</code>
